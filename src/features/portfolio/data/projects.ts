...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    features: [
      "MDX-powered blog with support for interactive and component-driven content.",
      "Custom shadcn/ui registry with CLI install support for reusable components.",
      "Command menu (⌘K) for fast navigation and global search across the site.",
      "Seamless dark, light, and system theme switching with smooth transitions.",
      "GitHub contribution graph integration to visualize coding activity.",
      "Optimized performance using Next.js 16 and TailwindCSS 4.",
      "SEO-ready with dynamic metadata, sitemap, RSS feeds, and llms.txt support.",
